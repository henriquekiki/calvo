...
timers = {
    "minato": {"fixed_time": datetime.timedelta(minutes=120), "custom_time": None},
    "mini minato": {"fixed_time": datetime.timedelta(minutes=60), "custom_time": None},
    "d reaper": {"fixed_time": datetime.timedelta(minutes=60), "custom_time": None},
}
...
async def miniminato(ctx, custom_minutes: int = None):
    if custom_minutes is not None:
        ...
        timers['mini minato']['fixed_time'] = datetime.timedelta(minutes=60)
